    ...
    <div class="container d-flex">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="portfolio.html">Registration</a></li>
          <li><a href="testimonials.html">Doctors</a></li>
          <li><a href="pricing.html">Payment</a></li>
        ...
        <div class="row">
          <div class="col-50">
           <label for="fname"></i> Full Name</label><br>
            ...
            <input type="text" id="date" name="date" placeholder="month-day-year"><br><br>
			<label for="email"><i class="fa fa-envelope"></i> Hospital</label><br>
            <input type="text" id="hospital" name="hospital" placeholder="Enter your preference hospital"><br><br>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        ...
        <div class="credits">
          ...
          Designed by Gloria Niyonkuru Sinseswa</a>
        </div>
      </div>
