    ...
    <div class="container d-flex">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="portfolio.html">Appointment</a></li>
          <li><a href="testimonials.html">Doctors</a></li>
          <li><a href="blog.html">hospital</a></li>
...
<div class="row">
  ...
  <p><label for="country">Select your preference hospital</label><br>
        <select id="hospital" name="hospital">
          <option value="king">King Faisal Hospital</option>
          <option value="kano">Kanombe Military Hospital</option>
          <option value="baho">BAHO International Hospital</option>
