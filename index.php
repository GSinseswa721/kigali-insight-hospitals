...
<head>
  ...
  <title>KIGALI INSIGHT HOSPITALS</title>
  ...
  <section id="topbar" class="d-none d-lg-block">
    <div class="container d-flex">
      <div class="contact-info mr-auto">
        ...
        <i class="icofont-phone"></i> +250 7840755717
      </div>
        ...
        <div class="carousel-item active" style="background-image: url(pro.jpg);">
          <div class="carousel-container">
            <div class="carousel-content animate__animated animate__fadeInUp">
              <h2>Welcome to <span>KIGALI INSIGHT HOSPITALS</span></h2>
              <p>Dear Patient,<br>
			  we would like to take this to opportunity to welcome you to our website KIGALI INSIGHT HOSPITALS. Thank you for choosing our services, we are excited to provide you with customized heath care that emphasizes wellness and prevention. Here you are going to meet with different doctors from overall hospitals in the city who are going to treat you perfectly and you are going to be better very soon </p>
            </div>
          </div>
        </div>

        <!-- Slide 2 -->
        <div class="carousel-item" style="background-image: url(convention.jpg);">
          <div class="carousel-container">
            <div class="carousel-content animate__animated animate__fadeInUp">
              <p><b>Further information</b><br>
			  The website is here to allow the patients to book the day by using web browser via the website. The first mission of us is to avoid long queue of patient at the hospital.It is here to perish manual system and also needed information are stored and can be retrieved easily. Morever having this website is going to help you to get all need information for your doctors, as well as the background of the hospitals that we have cooraboration with. </p>
