...
<div class="sidebar">
  <a href="Dash.php"><i class="fa fa-fw fa-home"></i> Home</a><br>
  <a href=""><i class="fa fa-list-alt"></i></i>Table</a><br>
  <a href="indexx.php"><i class="fa fa-sign-out"></i></i>Log out</a>
</div>


 <center>
 <H1>The dashboard for the Administrator</H1>
